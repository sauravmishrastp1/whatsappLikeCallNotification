...
import com.jb.FCMNotification.SoundPoolManager
...
//        soundPoolManager!!.playRinging()
        val fullScreenIntent = Intent(this, VideoCallingActivity::class.java)
        ...
        mBuilder.setContentText("Server Down")
